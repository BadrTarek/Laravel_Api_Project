...
@section('page_content')
   ...
   <div class="card">
    ...
    <div class="card-body">
      <form method="post" enctype= "multipart/form-data" action="/_admin/updateEmail/{{$email->id}}">
        @csrf
        <div class="mb-3">
          <label for="formGroupExampleInput" class="form-label">Email</label>
          <input type="text" class="form-control" value="{{ $email->email }}" name="email" required id="formGroupExampleInput">
        </div>
