...
@section('page_content')
   ...
   <div class="card">
    ...
    <div class="card-body">
      <form method="post" enctype= "multipart/form-data" action="/_admin/addPhone">
        @csrf
        <div class="mb-3">
          <label for="formGroupExampleInput" class="form-label">Phone</label>
          <input type="text" class="form-control" value="{{ old('phone') }}" name="phone" required id="formGroupExampleInput">
        </div>
        ...
        <button type="submit" name="addPhone" class="btn btn-outline-primary float-end">
